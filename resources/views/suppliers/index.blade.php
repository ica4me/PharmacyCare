        ...
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    ...
                    <p class="mb-0">Dasbor pemasok memungkinkan Anda untuk dengan mudah mengumpulkan dan memvisualisasikan data pemasok dari optimasi pengalaman pemasok, memastikan retensi pemasok. </p>
                </div>
                <div>
