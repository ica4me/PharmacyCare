        ...
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    ...
                    <p class="mb-0">Dasbor kehadiran memungkinkan Anda untuk dengan mudah mengumpulkan dan memvisualisasikan data kehadiran dari optimasi pengalaman kehadiran, memastikan retensi kehadiran </p>
                </div>
                <div>
