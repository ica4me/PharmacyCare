        ...
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    ...
                    <p class="mb-0">Dasbor permission memungkinkan Anda untuk dengan mudah mengumpulkan dan memvisualisasikan data permission dari optimasi pengalaman permission, memastikan retensi permission. </p>
                </div>
                <div>
