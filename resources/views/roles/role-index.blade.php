        ...
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    ...
                    <p class="mb-0">Dasbor peran memungkinkan Anda untuk dengan mudah mengumpulkan dan memvisualisasikan data peran dari optimasi pengalaman peran, memastikan retensi peran. </p>
                </div>
                <div>
