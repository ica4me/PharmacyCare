        ...
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    ...
                    <p class="mb-0">Dasbor produk memungkinkan Anda untuk dengan mudah mengumpulkan dan memvisualisasikan data produk dari optimasi pengalaman produk, memastikan retensi produk. </p>
                </div>
                <div>
