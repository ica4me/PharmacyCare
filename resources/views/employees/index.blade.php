        ...
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    ...
                    <p class="mb-0">"Dasbor karyawan memungkinkan Anda untuk dengan mudah mengumpulkan dan memvisualisasikan data karyawan dari optimasi pengalaman karyawan, memastikan retensi karyawan. </p>
                </div>
                <div>
