        ...
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    ...
                    <p class="mb-0">Dasbor pelanggan memungkinkan Anda untuk dengan mudah mengumpulkan dan memvisualisasikan data pelanggan dari optimasi pengalaman pelanggan, memastikan retensi pelanggan. </p>
                </div>
                <div>
