        ...
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    ...
                    <p class="mb-0">Dasbor kategori memungkinkan Anda untuk dengan mudah mengumpulkan dan memvisualisasikan data kategori dari optimasi pengalaman kategori, memastikan retensi kategori. </p>
                </div>
                <div>
