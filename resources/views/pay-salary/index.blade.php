        ...
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    ...
                    <p class="mb-0">Dasbor pembayaran gaji memungkinkan Anda untuk dengan mudah mengumpulkan dan memvisualisasikan data pembayaran gaji dari optimasi pengalaman pembayaran gaji, memastikan retensi pembayaran gaji. </p>
                </div>
                <div>
