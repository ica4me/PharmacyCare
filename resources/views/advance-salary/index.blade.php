        ...
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    ...
                    <p class="mb-0">Dasbor gaji muka memungkinkan Anda untuk dengan mudah mengumpulkan dan memvisualisasikan data gaji muka dari optimasi pengalaman gaji muka, memastikan retensi gaji muka. </p>
                </div>
                <div>
