        ...
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    ...
                    <p class="mb-0">Dasbor produk stok memungkinkan Anda untuk dengan mudah mengumpulkan dan memvisualisasikan data produk stok dari optimasi pengalaman produk stok, memastikan retensi produk stok. </p>
                </div>
            </div>
        </div>
